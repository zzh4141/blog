...
export default defineAppConfig({
    ...
    footer: {
        ...
        iconNav: [
            ...
            { icon: 'ph:github-logo-bold', text: 'GitHub: zzh4141', url: 'https://github.com/zzh4141' },
        ...
        nav: [
            ...
            },
            {
                title: '社交',
                items: [
                    { icon: 'ph:github-logo-bold', text: 'zzh4141', url: 'https://github.com/zzh4141' },
            ...
            },
            {
                ...
                items: [
                    ...
                    { icon: 'ph:certificate-bold', text: '萌ICP备20258870号', url: 'https://icp.gov.moe/?keyword=20258870' },
                    { icon: 'ph:certificate-bold', text: '团ICP备20254236号', url: 'https://icp.星.fun/id.php?keyword=20254236' },   
                ],
            },
        ] satisfies Nav,
        /** 页脚版权信息底部的其他信息 */
